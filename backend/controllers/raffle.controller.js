...
// yeni mail kaydet - kazanma şansları ile birlikte kaydet
const createNewMailForRestorant = asynchandler(async (req, res) => {
    const { hotelid, mailadress, fullname, due } = req.body;
    ...
    try {
        ...
        if (new_mail) {
          ...
          Your entry into our restaurant review promotion was successful. Your valuable review for the restaurant has been received through our app, and we're excited to share the details.

          Your Entry Details:
          Restaurant: ${hotel.hotelName}
          Your Unique Code: ${randomCode}

          How Does the Entry Work?
          By submitting your review through our app, you've earned a ticket for the chance to win a "Dinner for Two" at the end of the day. The more reviews you make, the higher your chances of winning this exciting prize!

          Prize Pool Selection Period:
          The prize pool selection period occurs every day at 20:00. At this time, a random code will be selected, and the lucky participant associated with that code will be announced as the winner of the dinner giveaway.

          We want to thank you for your contribution to improving restaurant experiences through your thoughtful reviews.

          Should you have any questions or encounter any issues, please don't hesitate to reach out to us. Our dedicated support team is here to assist you.

          Thank you for choosing MemoryBook for your restaurant review experiences. Best of luck in the prize draw, and we look forward to providing you with more exciting opportunities in the future!
          ...
          MemoryBook Team`;
            ...
            await transporter.sendMail({
                from: 'ebo.memorybook@gmail.com', // Gönderici e-posta adresi
                to: winner.mailadress, // Kazananın e-posta adresi
                subject: 'MemoryBook - Restaurant Review Promotion', // E-posta konusu
                text: mailContent // Metin tabanlı e-posta içeriği
            });
...
const raffle = asynchandler(async (req, res) => {
    try {
        ...
        const mailContent = `
            ...
            You won your draw in ${winner.randomCode} draws. Please contact Restaurant ${hotel.hotelName} for information.`;

        // E-posta gönder
        await transporter.sendMail({
            from: 'ebo.memorybook@gmail.com', // Gönderici e-posta adresi
            to: winner.mailadress, // Kazananın e-posta adresi
            subject: 'MemoryBook - Review Promotion', // E-posta konusu
            text: mailContent // Metin tabanlı e-posta içeriği
        });
...
const raffleRestorant = asynchandler(async (req, res) => {
    try {
        // Tüm raffleMailings verilerini al
        const raffleMailings = await _raffle.find();
        ...
        // Kazanan mail adresine gönderilecek e-posta içeriği
        const mailContentWinner = `
            Hello ${winner.fullname},

            You won your draw in ${winner.randomCode} draws. Please contact Restaurant ${hotel.hotelName} for information.
            Your winning email: ${winner.mailadress}
            Unique Code: ${winner.randomCode}
        `;

        const mailContentHotel = `
            Hello,

            The following participant has won the draw:
            Winner's Name: ${winner.fullname}
            Winner's Email: ${winner.mailadress}
            Unique Code: ${winner.randomCode}

            Please contact ${winner.fullname} for further information.
        `;

        // Kazanan mail adresine e-posta gönder
        await transporter.sendMail({
            from: 'ebo.memorybook@gmail.com', // Gönderici e-posta adresi
            to: winner.mailadress, // Kazananın e-posta adresi
            subject: 'MemoryBook - Review Promotion', // E-posta konusu
            text: mailContentWinner // Metin tabanlı e-posta içeriği
        });

        // Otel e-posta adresine kazanan bilgilerini gönder
        await transporter.sendMail({
            from: 'ebo.memorybook@gmail.com', // Gönderici e-posta adresi
            to: hotel.hotelMailAdress, // Otelin e-posta adresi
            subject: 'MemoryBook - Winner Information', // E-posta konusu
            text: mailContentHotel // Metin tabanlı e-posta içeriği
        });
        ...
        res.status(200).json({
            ...
            title: "Kazanan mail adresi belirlendi, e-posta gönderildi ve kazanan veritabanına kaydedildi.",
            winner,
            randomCode: winner.randomCode // Sadece geliştirme amaçlı, gerçekte bu kodu kullanıcıya göndermeden önce saklamalısınız
        });
    } catch (error) {
        res.status(500).json({
            status: 500,
...
module.exports =
{
    ...
    createNewMailForRestorant, // resotrant mail kaydet
    raffleRestorant
}